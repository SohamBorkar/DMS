...
<form action="" method="post" role="form" class="">
  <div class="row gy-2 gx-md-3">
    ...
    <div class="form-group col-12" style="margin-bottom:18px">
      ...
      <input type="number" class="form-control" name="harm_level" id="h_level" placeholder="Type Harm Level of Criminal" required min="0">
    </div>
    ...
    <div class="text-center col-12"><button type="submit" class="btn btn-primary btn-lg btn-block" name="submit">Add Criminal</button></div>
  </div>
</form>
</div>
<?php
...
if (isset($_POST['submit'])) {
  ...
  $stmt = $conn->prepare("INSERT INTO criminal (cid, name, dob, c_name, prev_crimes, harm_level, case_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("isssiii", $id, $name, $dob, $case_n, $previous_c, $harm_l, $case_id);
  ...
  if ($stmt->affected_rows > 0) {
    echo "<script> alert('Criminal Added Successfully');</script>";
  } else {
